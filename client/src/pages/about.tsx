      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Dr. Mai Solgunn Glasø Slåttebrekk ble ferdigutdannet tannlege i 1993 etter å ha studert ved Odontologisk fakultet i Oslo, og har drevet privat praksis siden. 
              Med over 30 års erfaring tilbyr hun trygg og profesjonell tannpleie.
            </p>
            <p className="text-gray-600 mb-6 leading-relaxed">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:order-1">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Malin har jobbet hos Tannlege Slåttebrekk siden 2016 og er en viktig del av teamet vårt. 
