    ...
    <div className="bg-white">
      ...
      <section id="behandlinger" className="scroll-mt-12 py-16 px-4 md:px-12 max-w-4xl mx-auto bg-gray-50">
        ...
        {behandlingerLoading ? (
          ...
          <div className="text-center py-8">
            <p className="text-red-600 mb-4">Kunne ikke hente behandlinger fra Google Sheets</p>
            <p className="text-gray-600 text-sm">Vennligst kontakt oss for oppdaterte priser</p>
          </div>
        ) : (
